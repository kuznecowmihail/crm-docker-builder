...
export class CrmDockerBuilderValidatorService implements IService {
  ...
  public setupHandlers(): void {
    ...
    ipcMain.handle(IPC_CHANNELS.CRM_DOCKER_BUILDER_VALIDATOR_SYSTEM.VALIDATE_RABBITMQ_SETTINGS, async (event, projectConfig: ProjectConfig, rabbitmqConfig: RabbitmqConfig) => {
